...
class RolloutStateSpaceExperimentCP(Experiment):
    """An experiment for plotting rollout performance of controllers.
    """"Implement the controller that is based on learned CLF with CP on the ground truth model"""""
    ...
    def __init__(
        ...
        """
        super(RolloutStateSpaceExperimentCP, self).__init__(name)
    ...
    def run(self, controller_under_test: "Controller") -> pd.DataFrame:
        ...
        for tstep in prog_bar_range:
            ...
            if tstep % controller_update_freq == 0:
                ...
                u_current = controller_under_test.u_cp(x_current)
                end_time = time.time()
                controller_calls += 1
            ...
            # TODO: Use the ground truth model here
            for i in range(n_sims):
